...
class CodeBrowser(Container):
    ...
    def handle_file_selected(self, message: DirectoryTree.FileSelected) -> None:
        ...
        self.post_message(
            CurrentFileInfoBar.FileInfoUpdate(new_file=file_info))
    ...
    def _get_download_file_name(self) -> UPath:
        ...
        download_path = download_dir / \
            self.selected_file_path.name  # type: ignore[union-attr]
        handled_download_path = handle_duplicate_filenames(

...
class WindowSwitcher(Container):
    ...
    def __init__(
        ...
        self.static_window = StaticWindow(
            expand=True, config_object=config_object)
    ...
    def render_file(self, file_path: UPath, scroll_home: bool = True) -> None:
        ...
        if joined_suffixes in self.datatable_extensions:
            ...
            syntax = self.static_window.text_to_syntax(
                text=string, file_path=file_path)
